...
import EmptyWishlistIcon from '@/components/icons/empty-cart';
...
const WishlistSidebarView = () => {
  ...
  const { items, totalUniqueItems, total } = useWishlist();
      ...
      <AnimateSharedLayout>
        <motion.div layout className="flex-grow pt-16 pb-20">
          {items.length > 0 ? (
            ...
            >
              <EmptyWishlistIcon width={140} height={176} />
