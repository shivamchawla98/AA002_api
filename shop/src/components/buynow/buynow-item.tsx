...
interface BuyNowItemProps {
  item: any;
}

const BuyNowItem = ({ item }: BuyNowItemProps) => {
  const { t } = useTranslation('common');
  const { isInStock, clearItemFromBuyNow, addItemToBuyNow, removeItemFromBuyNow } =
    useBuyNow();
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={() => clearItemFromBuyNow(item.id)}
      >
