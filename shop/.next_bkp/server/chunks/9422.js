...
const SlidingCardCategories1 = ({ notFound , categories , loading ,  })=>{
    if (loading) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SlidingCardCategories1);
